...
function Add(props) {
  ...
  const [endOfService, setEndOfService] = useState(new Date());
  const [nationalIdScanName, setNationalIdScanName] = useState("");
  const [nationalIdScan, setNationalIdScan] = useState("");
  const [militaryStatusScanName, setMilitaryStatusScanName] = useState("");
  const [militaryStatusScan, setMilitaryStatusScan] = useState("");
  const [insuranceNumberScanName, setInsuranceNumberScanName] = useState("");
  ...
  const [certificateScanName, setCertificateScanName] = useState("");
